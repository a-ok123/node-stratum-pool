...
exports.createGeneration = (rpcData, blockReward, feeReward, recipients, poolAddress, poolHex, coin,
    ...
    if (coin.symbol === 'psl' || coin.symbol === 'lsp') {
        ...
        // console.log('minerReward (' + Math.round(blockReward.total) + ')');
        // console.log('minerReward (' + Math.round(blockReward.total * (1 - (feePercent / 100))) + ')');
        // console.log('minerReward (' + (Math.round(blockReward.total * (1 - (feePercent / 100))) + feeReward - masternodeReward - governanceReward) + ')');
        // console.log('masternodeReward (' + masternodeReward + ')');
        // console.log('governanceReward (' + governanceReward + ')');
        txb.addOutput(
            scriptCompile(poolAddrHash),
            Math.round(blockReward.total * (1 - (feePercent / 100))) + feeReward - masternodeReward - governanceReward
        );
